            ...
            <ul>
              <li className="wow fadeInUp" data-wow-duration=".7s">
                <div className="list_inner">
                  <span>2023-November -{">"} 2024-August</span>
                </div>
                <div className="list_inner">
              ...
              >
                <div className="list_inner">
                  <span>2023-November -{">"}  Present</span>
                </div>
                <div className="list_inner">
              ...
              >
                <div className="list_inner">
                  <span>2023-August -{">"} 2023-September</span>
                </div>
                <div className="list_inner">
                  <span>
              ...
              >
                <div className="list_inner">
                  <span>2022-November -{">"} 11 - 2023-January</span>
                </div>
                <div className="list_inner">
                  <span>
                    Team Lead, Frontend Developer, UX &amp; UI Designer
              ...
              >
                <div className="list_inner">
                  <span>2022-April -{">"} 2023-July</span>
                </div>
                <div className="list_inner">
