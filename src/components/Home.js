...
const Home = () => {
  ...
  const content = {
    ...
    Achievement: `
      <p>
        As a developer, I continually expand my skills through online learning on platforms like freeCodeCamp, Udemy, and LinkedIn. This self-driven learning keeps me updated and enhances my technical abilities.
        Access my achivment <a href="https://drive.google.com/drive/folders/1e2ZYkkeiVvtCCBdeqLHmClQ8rJNxhaKu?usp=sharing" target="_blank">here</a>
      </p>
    `,
  };
        ...
        <div className="container">
          <div className="content">
            <div className="left">
              ...
              <h3 className="job">Web Designer & Frontend Developer</h3>
